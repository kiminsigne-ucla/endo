...
write.fasta(train, names = active_names[train_index], nbchar = 300,
            file.out = '../processed_data/gkmsvm_results/tss/tss_positives_train.fasta')
...
write.fasta(neg_train, names = names(neg_train), nbchar = 300,
            file.out = '../processed_data/gkmsvm_results/tss/tss_negatives_train.fasta')

write.fasta(neg_test, names = names(neg_test), nbchar = 300,
            file.out = '../processed_data/gkmsvm_results/tss/tss_negatives_test.fasta')


gkmsvm_kernel(posfile = "../processed_data/gkmsvm_results/tss/tss_positives_train.fasta", 
              negfile = "../processed_data/gkmsvm_results/tss/tss_negatives_train.fasta", 
              outfile = '../processed_data/gkmsvm_results/tss/10mer_8ungapped_kernel', 
              L = 10, K = 8)

# perform SVM training with cross-validation
gkmsvm_trainCV(kernelfn = '../processed_data/gkmsvm_results/tss/10mer_8ungapped_kernel',
               posfn= "../processed_data/gkmsvm_results/tss/tss_positives_train.fasta", 
               negfn = "../processed_data/gkmsvm_results/tss/tss_negatives_train.fasta",
               svmfnprfx='../processed_data/gkmsvm_results/tss/10mer_8ungapped_kernel', 
               outputCVpredfn='../processed_data/gkmsvm_results/tss/10mer_8ungapped_cvpred',
               outputROCfn='../processed_data/gkmsvm_results/tss/10mer_8ungapped_roc', 
               L = 10, K = 8)

ggsave('../processed_data/gkmsvm_results/tss/10mer_8ungapped_ROC_PR_curves.png')
