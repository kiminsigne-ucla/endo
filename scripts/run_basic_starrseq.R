...
run_basic_starrseq <- function(rna_file, dna_file, peak_width = 100) {
    ...
    peaks <- getPeaks(data, deduplicate = F, peakWidth = peak_width)
    head(peaks)
...
write_results(peaks_plus,
              new_strand = '+',
              "../processed_data/basic_starrseq_results/plus_peaks_100bp.bed")
