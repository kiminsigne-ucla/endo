...
def mapping(barcodes, perfect_reads, reads, bc_loc, bc_len, var_len, controls=None):
...
def filter_barcodes(barcode_map, cutoff, bc_loc, bc_len, var_len, 
	name, lib, controls=None):
	'''
