...
start = TextInput(value='89000', title='genome (U00096.2) start position')
end = TextInput(value='90000', title='genome end position')
...
controls_group2 = WidgetBox(gene_button, start, end, add_button)
