#ifndef CANALYSISDOUBLE_H_
#define CANALYSISDOUBLE_H_
...
class canalysisdouble{
	
	public:
	
		canalysisdouble(); //Implemented
		~canalysisdouble(); //Implemented
		int importCoords(const char *);//Implemented
		int processCoords(const char *,const char *,const char *);//Implemented
		int outputData(const char *,int,unsigned short int,unsigned long int,unsigned long int,unsigned short int,double,int,double[]);//Implemented
