coord.sbpd=function(inputfile,coordfile,outputfile,twobitfile){
    ...
    cReturn <- .C("coordSeqDouble",as.character(inputfile),as.character(coordfile),as.character(outputfile),as.character(twobitfile),PACKAGE="zinba")
}
